...
{Self Employed \space\cpipe\space Freelance}
{
	...
	\begin{minipage}[t]{0.75\textwidth}				
		...
		\vspace{-3mm}\\
		\itemmarker Executed software releases via automated CI/CD pipelines and maintain version control to monitor development and release processes.\\
        \vspace{-3mm}\\
...
\vspace{-3mm}\\  
	...
	\techlist{UML, Jira, Diagrams.net, Software Engineering, Python, Django, Machine Learning, NLP}
}
{Software Engineer | Project Manager}
	...
	{Self Employed \space\cpipe\space Freelance}
	{
		...
		\techlist{Python, Django, Docker Compose, AWS Cloud, Ansible, MLFlow, Bitbucket, NLP}
	}
	{Software Engineer}
...
\begin{minipage}[t]{0.45\textwidth}
	...
	\begin{minipage}[t]{\textwidth}
		...
		\hspace{7mm} \cvskill{Agile Methodologies}{4}
...
\begin{minipage}[t]{0.45\textwidth}
	...
	\\
	\begin{minipage}[t]{\textwidth}
    		\hspace{7mm} \cvskill{Docker and Docker Compose}{4}
